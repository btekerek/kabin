...
/// PIN entry -> channel picker, with no Scaffold/AppBar of its own so it
/// can be embedded either as ListenerJoinScreen's whole body (the '/join'
/// route) or as one segment of LandingScreen's listener-first tabs.
class ListenerJoinBody extends ConsumerStatefulWidget {
  const ListenerJoinBody({super.key});

  @override
  ConsumerState<ListenerJoinBody> createState() => _ListenerJoinBodyState();
}

class _ListenerJoinBodyState extends ConsumerState<ListenerJoinBody> {
